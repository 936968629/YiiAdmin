                        ...
                        <form class="form builder-form" name="menuForm">
                            ...
                            <div class="form-group item_pid ">
                                ...
                                <div class="controls">
                                    ...
                                    <input type="text" class="form-control input text" name="name" value="<?= $info['name'] ?? '' ?>">                            </div>
                            </div><div class="form-group item_url ">
                                <label class="item-label">链接(顶级菜单可不填)</label>
                                <div class="controls">
                                    <input type="text" class="form-control input text" name="url" value="<?= $info['url'] ?? '' ?>">                            </div>
                            </div>
                            <div class="form-group item_sort ">
                                <label class="item-label">排序<span class="check-tips">（<span class="small">用于显示的顺序</span>）</span></label>
                                <div class="controls">
                                    <input type="text" class="form-control input num" name="list" value="<?= $info['list'] ?? '' ?>">                            </div>
